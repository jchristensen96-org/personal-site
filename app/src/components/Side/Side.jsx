    ...
    <div>
      <div className="side-container">
        <div className="side-header">
          <img src="https://jc-ecom-app-images-209328912.s3.amazonaws.com/images/project/U8wQcYEnnEm3rEw6ZG.png" alt="" />
          <h3 className="side-header-name">JON CHRISTENSEN</h3>
          <p className="side-header-email">jon@jonathanchristensen.com</p>
        </div>
        <div className="side-body">
          ...
          <div className="side-body-about">
            ...
            <Link className="side-button" to="/resume">LEARN MORE</Link>
          </div>
          <hr className="side-divide" />
          <div className="side-download-cv">
            <a target="_blank" href="https://pa45hr9jsw59xva4txbdm2at88c55idp.s3.amazonaws.com/personal-site/Resumev1.pdf" download="Jonathan Christensen Resume">DOWNLOAD CV</a>
          </div>
        </div>
      </div>
